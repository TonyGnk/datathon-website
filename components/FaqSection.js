    ...
    const faqData = [
        {
            ...
            answer: 'Το Datathon @UoM είναι ένας ετήσιος διαγωνισμός ανοικτών δεδομένων που διοργανώνεται, κυρίως, από φοιτητές του ΠαΜακ. Φοιτητές από όλη τη χώρα οργανώνονται σε ομάδες και συνεργάζονται για μια ημέρα, αξιοποιώντας τις παρεχόμενες πύλες ανοικτών δεδομένων με στόχο να λύσουν συγκεκριμένα προβλήματα ή να δημιουργήσουν προβλέψεις. Ως αποτέλεσμα, αναπτύσσονται νέες ιδέες και εφαρμογές για τη βελτίωση υφιστάμενων ή τη δημιουργία εντελώς πρωτοφανών υπηρεσιών.'
        },
        {
